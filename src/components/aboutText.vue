...
<template>
    <div class="flex flex-col items-start lg:w-1/2">
        ...
        <p class="py-4 text-lg font-normal text-center subtitle-dark lg:text-left font-header text-slate-400">
            ...
            <a href="https://indonesia-public-static-api.vercel.app/api/volcanoes"
                class="font-bold font-main text-slate-600 dark:text-white">
                API
            </a>
            dari
            <a href="https://github.com/yogski" class="font-bold font-main text-slate-600 dark:text-white">Yogi
                Saputro</a>
        </p>
    </div>
</template>
